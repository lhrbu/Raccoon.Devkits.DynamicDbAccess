...
namespace Raccoon.Devkits.DynamicDbAccess.TestWebAPIServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllers(options=>options.Filters.Add(typeof(DynamicTransactionFilter)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Raccoon.Devkits.DynamicDbAccess.TestWebAPIServer v1"));
            }
